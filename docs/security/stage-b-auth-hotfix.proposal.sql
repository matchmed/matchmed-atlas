-- =============================================================================
-- STAGE B — Authenticated security hotfix (proposal mirror)
-- Tracked migration: supabase/migrations/20260803030000_stage_b_auth_hotfix.sql
-- Rollback: docs/security/stage-b-auth-hotfix.rollback.sql
-- Prerequisites (verified live): physician jobs RPCs + physician app surfaces.
-- Do NOT apply Stage C / anon revoke / public routes with this file.
-- =============================================================================
