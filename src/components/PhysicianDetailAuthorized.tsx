...
export default function PhysicianDetailAuthorized() {
  ...
  function renderAffilCard(a: Affiliation) {
    ...
    return (
      <div key={a.id} style={{ background: '#ffffff', border: '1px solid #DDD8D0', borderRadius: 10, padding: '16px 18px', marginBottom: 10, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
